        ...
        <div class="row mt-1 mb-1">
            ...
            <?php 
                ...
                if (isset($_SESSION["u"])) {
                    $data = $_SESSION["u"];
                    ?>
                    <span class="text-lg-start text-success">Hi, <b><?php echo ($data["fname"]);?></b></span> &nbsp; &nbsp;| &nbsp;
                    <span class="text-lg-start fw-bold signout" onclick="signOut();">Sign Out</span> &nbsp; | &nbsp;
                    <?php
                } else {
                    ?><a href="index.php" class="text-decoration-none text-lg-start fw-bold signout">Sign In or Register</a> &nbsp;| &nbsp;<?php
                }
            ?>
