                    ...
                    <div class="row">
                        <div class="col-12 align-items-start bg-dark vh-100">
                            <div class="row g-1 text-center">
                                ...
                                <div class="col-12 mt-5">
                                    <hr class="border border-1 border-white" />
                                    <a href="sellingHistory.php" style="text-decoration: none;"><h4 class="text-white fw-bold">Selling History</h4></a>
                                    <hr class="border border-1 border-white" />
                                </div>
                                ...
                                <div class="col-12 col-lg-10 text-center my-3">
                                    ...
                                    <label class="form-label fs-4 fw-bold text-warning">
                                        ...
                                        echo $difference->format("%Y"). "  " . "Years" . "  " . $difference->format("%m"). "  " . "Months"
                                            ...
                                            . "  " . $difference->format("%m"). "  " . "Minutes" . "  " . $difference->format("%s"). "  " . "Seconds";
                            ...
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center my-3">
                                        ...
                                        <span class="fs-6"><?php echo $pqty; ?> items</span><br />
                            ...
                            <div class="row g-1">
                                ...
                                ?>
                                    ...
                                    <div class="col-12 text-center my-3">
                                        ...
                                        <span class="fs-6"><?php echo $user_data1["mobile"]; ?></span><br />
