        ...
        <div class="app-body">
            ...
            <div class="app-body-main-content">
                <section class="service-section">
                    <h2 style="font-size: 14px;">Stop Charging</h2>
                    ...
                    <center>
                        ...
                        <button id="stopChargingButton" style="background-color: red;color: white; font-size: 22px; box-shadow: 0 0 20px rgb(241, 152, 152);" class="startstopbtn" >END CHARGING</button> 
                    
                    </center><br/><br/><br/>
                    <div>
                    <h1 style="text-align: center; margin-top: -30px;" id="stopHeadText">Your Vehicle is currently Charging</h1><br/>

                    </div><div id="stopPagePaymentBtn" style="display: none;">
                        <center>
                        <p style="text-align: center;font-size: 13px; margin-top: -20px; color: rgb(124, 123, 123);">Click here to pay</p>

                            <a href="payment.php"><button style="width: 50%; padding: 10px;border-radius: 15px; font-size: 15px;font-weight: bold; color: rgb(0, 0, 0); background-color:#45ffbc;cursor: pointer;" >Proceeed To Payment</button></a> </div>
                            </center>
                    </div>
                    </div>
