        ...
        <div class="app-body">
            ...
            <div class="app-body-main-content">
                <section class="service-section">
                    ...
                    <h1 style="text-align: center; margin-top: -30px;">Select Your Slow Chargers</h1><br />
                    ...
                    <div class="appContainer" style="margin-top: 5px;">
                        ...
                        <div class="tiles">
                            ...
                            $charger_q = "SELECT * FROM `chargers` WHERE `charger_type` = 'slow' AND `status` = '1';";
                            ...
                            ?>
                                <button class="tile" id="<?php echo $chargerId; ?>" onclick="handleChargerClick('<?php echo $chargerId; ?>')">
                                    <div class="tile-header">
                                        ...
                                        <h3>
                                            <span>Slow Charger 0<?php echo($i);?></span>
                                            <span></span>
