This project is a system designed for Fredrick's, an electric vehicle (EV) charging station located in Kotte. Developed using PHP and a MySQL database, it includes the following key features:
